...
config = Cfg.load_config_from_file(r"D:\code\thuc_tap_2025\teknix\14_10_2025\tran_train\tran_config_14_10_2025.yml")
config['weights'] = r"D:\code\thuc_tap_2025\teknix\14_10_2025\tran_train\transformerocr_14_10_2025_final.pth"
...
dynamic_shapes = {
    'tgt_inp': {0: (1, 128), 1: (1, 1)},   # (seq_len, batch) ví dụ
    'memory': {0: (1, 256), 1: (1,)},      # (feat_width, batch)
    'values': {0: (1, 1), 1: (1, 128)},    # (batch, seq_len)
    'indices': {0: (1, 1), 1: (1, 128)}
}
